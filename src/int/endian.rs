...
mod tests {
    ...
    test_bignum! {
        function: <i128>::to_be_bytes(a: i128),
        cases: [
    ...
    test_bignum! {
        function: <i128>::to_le_bytes(a: i128),
        cases: [
    ...
    test_bignum! {
        function: <i128>::to_ne_bytes(a: i128),
        cases: [
    ...
    test_bignum! {
        function: <i128>::from_be_bytes(a: U8ArrayWrapper<16>),
        cases: [
    ...
    test_bignum! {
        function: <i128>::from_le_bytes(a: U8ArrayWrapper<16>),
        cases: [
    ...
    test_bignum! {
        function: <i128>::from_ne_bytes(a: U8ArrayWrapper<16>),
        cases: [
