...
mod tests {
    ...
    test_unsigned! {
        test_name: test_wrapping_div_euclid,
        method: {
    ...
    test_unsigned! {
        test_name: test_wrapping_rem_euclid,
        method: {
    ...
    test_unsigned! {
        test_name: test_wrapping_shl,
        method: {
            wrapping_shl(932769476979405769495675499u128, 395879u32);
            wrapping_shl(1093457349754735987349857453u128, 77u32);
        }
    }
    test_unsigned! {
        test_name: test_wrapping_shr,
        method: {
            wrapping_shr(37462745603947597349857345u128, 1973u32);
            wrapping_shr(13945603458763847597349573945u128, 14u32);
        }
    }
    test_unsigned! {
        test_name: test_wrapping_pow,
        method: {
            wrapping_pow(345973457475345345564u128, 456465613u32);
            wrapping_pow(234u128, 6u32);
        }
    }
}