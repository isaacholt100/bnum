...
///
/// This error can occur when the `from_str_radix` or [`FromStr::from_str`](https://doc.rust-lang.org/core/str/trait.FromStr.html#tymethod.from_str) methods of e.g. [`BUintD8`](crate::BUintD8::from_str_radix) are called with an invalid input string.
